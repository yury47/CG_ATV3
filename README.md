...
Basta entrar no link [Olha_o_sapo_v2](https://yury47.github.io/CG_ATV3/public/Olha_o_sapo_v2.html).
...
As descrições abaixo fornecem um resumo técnico das funcionalidades implementadas em cada arquivo. Consulte a pasta **examples/Olha_o_sapo_v2** deste repositório para obter os arquivos do projeto.
