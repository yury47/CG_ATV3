...
As descrições abaixo fornecem um resumo técnico das funcionalidades implementadas em cada arquivo. Consulte a pasta **Olha_o_sapo_v2** deste repositório para obter os arquivos do projeto.
